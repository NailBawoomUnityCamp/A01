...
{	class Shop
	{
		...
		public Shop(Warrior customer, UI ui)
		{
			...
			Add(new Equipment("수련자 갑옷", EquipmentType.Body, 5, " 수련에 도움을 주는 갑옷입니다. ", ItemType.Defence, 1100));
			Add(new Equipment("무쇠갑옷", EquipmentType.Body, 9, " 수련에 도움을 주는 갑옷입니다. ", ItemType.Defence, 2000));
			...
			Add(new Equipment("스파르타의 단도", EquipmentType.OneHand, 6, "스파르타 전사들이 썼다는 단도입니다", ItemType.Attack, 2700));
			_customer = customer;
			_ui = ui;
		}
